...
namespace VacationRental.Api.Tests
{
    ...
    public class CalendarTests
    {
        ...
        public CalendarTests(IntegrationFixture fixture)
        {
        ...
        public async Task GivenCompleteRequest_WhenGetCalendar_ThenAGetReturnsTheCalculatedCalendar()
        {
            ...
            using (var getCalendarResponse = await _client.GetAsync($"{ApiConstants.CALENDAR_URI}?rentalId={postRentalResult.Id}&start=2000-01-01&nights=5"))
            {
                ...
                Assert.Contains(getCalendarResult.Dates[2].Bookings, x => x.Unit == 1);
